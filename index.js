...
module.exports.services.Bitcoin = require('./lib/services/digicoind');
module.exports.services.Digicoin = require('./lib/services/digicoind');
...
module.exports.lib = require('digicoincore-lib');
